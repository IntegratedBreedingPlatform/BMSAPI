...
public class CropNameValidationInterceptorTest {
	...
	public void beforeEachTest() throws IOException {
		...
		validationInterceptor = new CropNameValidationInterceptor();
		validationInterceptor.setWorkbenchDataManager(this.workbenchDataManager);
		validationInterceptor.setRequestInformationProvider(this.requestInformationProvider);
