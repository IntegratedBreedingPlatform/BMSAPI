...
public class StudyServiceImplTest {
    ...
    public void testGetFieldMap() throws Exception{
        ...
        FieldMapLabel fieldMapLabel = StudyTestDataProvider.createFieldMapLabel();
		FieldMapTrialInstanceInfo trialInstanceInfo = StudyTestDataProvider.createFieldMapTrialInstanceInfo(fieldMapLabel);

        //Setting FieldMapDatasetInfo values
        FieldMapDatasetInfo datasetInfo = new FieldMapDatasetInfo(1, "Dataset Name", Lists.newArrayList(trialInstanceInfo));
        ...
        FieldMapPlantingDetails plantingDetails = StudyTestDataProvider.createFieldMapPlantingDetails();

        //Setting FieldMapStudySummary values
        FieldMapStudySummary studySummary =  StudyTestDataProvider.createFieldMapStudySummary();
