...
public class CallResourceBrapiTest extends ApiUnitTestBase {
	...
	public void testListAvailableCalls() throws Exception {
		...
		Mockito.when(this.callService.getAllCalls(null, CallResourceBrapi.VERSION, null, null)).thenReturn(this.calls);
	...
	public void testListAvailableCallsWithDatatype() throws Exception {
		Mockito.when(this.callService.getAllCalls("csv", CallResourceBrapi.VERSION, null, null)).thenReturn(this.calls);
