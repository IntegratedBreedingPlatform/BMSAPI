...
public class TransactionResourceTest extends ApiUnitTestBase {
	...
	public void testSearchTransactions() throws Exception {
		...
		transactionDto.setDesignation("germplasm");
		transactionDto.setGid(1);
		transactionDto.setLotId(2);
		transactionDto.setNotes("Deposit");
		transactionDto.setScaleId(8264);
		transactionDto.setScaleName("SEED_AMOUNT_g");
		transactionDto.setStockId("ABC-1");
