...
public class IBSampleClient {
    ...
    public void before() throws Exception {
        ...
        webapp.setContextPath("/IBPWebService");
        webapp.setWar("target/IBPWebService.war");
    ...
    @Test
    public void upload() {
        uploadFile("http://localhost:8080/IBPWebService/rest/breeding_view/ssa/save_result", "data.csv");
    }

    @Test
    public void readOutputBreedingView() {
        String url = "http://localhost:8080/IBPWebService/rest/breeding_view/ssa/save_result?" +
                "Filename=C:/Efficio/3rdComing/trunk/IBPWebService/src/test/resources/Burkina_trait_means.csv&" +
                "StudyId=-1&WorkbenchProjectId=1&InputDataSetId=1&OutputDataSetId=1";
