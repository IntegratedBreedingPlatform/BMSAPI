...
public class ExperimentalDesignResource {
	...
	@PreAuthorize("hasAnyAuthority('ADMIN', 'STUDIES', 'MANAGE_STUDIES', 'EXPERIMENTAL_DESIGN', 'GENERATE_EXPERIMENTAL_DESIGN')")
	...
	@PreAuthorize("hasAnyAuthority('ADMIN','STUDIES','MANAGE_STUDIES', 'EXPERIMENTAL_DESIGN','DELETE_EXPERIMENTAL_DESIGN')")
