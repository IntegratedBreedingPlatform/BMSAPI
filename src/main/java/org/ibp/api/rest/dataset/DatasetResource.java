...
public class DatasetResource {
	...
	@RequestMapping(value = "/{crop}/programs/{programUUID}/variable/{variableId}/validate-alias", method = RequestMethod.POST)
	public ResponseEntity<Boolean> validateVariableAlias(
		@PathVariable final String crop, @PathVariable final String programUUID, @PathVariable final Integer variableId,
		@RequestParam(value = "alias") final String alias) {

		try {
			this.datasetValidator.validateVariableStudyAlias(alias, programUUID, variableId);
