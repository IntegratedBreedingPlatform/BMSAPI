 ...
 */
@Service
public class GOBiiExperimentService {

	private static final Logger LOG = LoggerFactory.getLogger(GOBiiExperimentService.class);

	private final RestTemplate restTemplate;

	public GOBiiExperimentService() {
	...
	public Integer postGOBiiExperiment(final GOBiiToken goBiiToken, final GOBiiExperiment goBiiExperiment) {
		...
		try {
			...
			try {
				String jsonInString = mapper.writeValueAsString(goBiiExperiment);
				System.out.println();
			}catch (Exception e) {
