 ...
 */
@AutoProperty
public class GOBiiProjectPayload extends GOBiiGenericPayload {

	@AutoProperty
	public static class ProjectData extends GOBiiGenericData {
		@AutoProperty
		class Property {
	...
	public void setData(final List<ProjectData> data) {
		this.data = data;
	}
