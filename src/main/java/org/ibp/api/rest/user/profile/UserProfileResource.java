...
public class UserProfileResource {
	...
	public ResponseEntity<Integer> updateProfile(
		...
		try {
			...
			throw new ApiRuntimeException("The password is worng, please check");
		}
		WorkbenchUser workbenchUser = userServiceMiddleware.getUserByUsername(userProfileDto.getUserName());
