...
import org.ibp.api.java.attribute.AttributeService;
...
public class AttributeResource {
	...
	public ResponseEntity<GermplasmAttributeRequestDto> createGermplasmAttribute(@PathVariable final String cropName,
		...
		return new ResponseEntity<>(this.attributeService.createGermplasmAttribute(gid, requestDto), HttpStatus.OK);
	}
