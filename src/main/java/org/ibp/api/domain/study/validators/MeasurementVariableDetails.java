...
/**
 * Data structure to extract and hold details needed validate a measurement value.
 *
 */
public class MeasurementVariableDetails {
	...
	public MeasurementVariableDetails(final String variableId, final String variableName, final DataType variableDataType,
