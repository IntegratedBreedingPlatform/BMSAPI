...
public class Usage {
	...
	public boolean isVariableSystem() {
		return this.isVariableSystem;
	}

	public void setVariableSystem(final boolean variableSystem) {
		this.isVariableSystem = variableSystem;
	}
}
