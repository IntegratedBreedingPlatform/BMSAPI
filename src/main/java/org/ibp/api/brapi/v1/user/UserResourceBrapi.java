...
public class UserResourceBrapi {
	...
	@RequestMapping(value = "/brapi/v1/users/user", method = RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value = "/brapi/v1/users/user", method = RequestMethod.PUT)
	@ResponseBody
	public ResponseEntity<GenericResponse> updateUser(@RequestBody UserDetailsDto user) {
