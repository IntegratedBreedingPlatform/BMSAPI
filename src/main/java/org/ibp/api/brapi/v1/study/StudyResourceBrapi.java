...
public class StudyResourceBrapi {
    ...
    public ResponseEntity<EntityListResponse<StudyDto>> listStudies(@PathVariable final String crop,
                                                                    @ApiParam(value = "Common name for the crop associated with this study.") @RequestParam(value = "commonCropName", required = false) final String commonCropName,
                                                                    @ApiParam(value = "Filter based on study type unique identifier") @RequestParam(value = "studyTypeDbId", required = false) final String studyTypeDbId,
                                                                    ...
                                                                    @ApiParam(value = "Sort order direction. Ascending/Descending.") @RequestParam(value = "sortOrder", required = false) final String sortOrder,
        ...
        return this.getEntityListResponseResponseEntity(studyTypeDbId, programDbId, locationDbId, seasonDbId, trialDbId, studyDbId, active, sortBy, sortOrder, currentPage, pageSize);
    }

    @RequestMapping(value = "/brapi/v1/studies", method = RequestMethod.GET)
    @ResponseBody
    public ResponseEntity<EntityListResponse<StudyDto>> listStudies(
            @ApiParam(value = "Common name for the crop associated with this study.") @RequestParam(value = "commonCropName", required = false) final String commonCropName,
            @ApiParam(value = "Filter based on study type unique identifier") @RequestParam(value = "studyTypeDbId", required = false) final String studyTypeDbId,
            @ApiParam(value = "Program filter to only return studies associated with given program id.")
            @RequestParam(value = "programDbId", required = false) final String programDbId,
    ...
    private ResponseEntity<EntityListResponse<StudyDto>> getEntityListResponseResponseEntity(@RequestParam(value = "studyTypeDbId", required = false) @ApiParam("Filter based on study type unique identifier") final String studyTypeDbId, @RequestParam(value = "programDbId", required = false) @ApiParam("Program filter to only return studies associated with given program id.") final String programDbId, @RequestParam(value = "locationDbId", required = false) @ApiParam("Filter by location.") final String locationDbId, @RequestParam(value = "seasonDbId", required = false) @ApiParam("Filter by season.") final String seasonDbId, @RequestParam(value = "trialDbId", required = false) @ApiParam("Filter by trial.") final String trialDbId, @RequestParam(value = "studyDbId", required = false) @ApiParam("Filter by study DbId") final String studyDbId, @RequestParam(value = "active", required = false) @ApiParam("Filter active status true/false.") final Boolean active, @RequestParam(value = "sortBy", required = false) @ApiParam("Name of the field to sort by.") final String sortBy, @RequestParam(value = "sortOrder", required = false) @ApiParam("Sort order direction. Ascending/Descending.") final String sortOrder, @RequestParam(value = "page", required = false) @ApiParam(value = BrapiPagedResult.CURRENT_PAGE_DESCRIPTION, required = false) final Integer currentPage, @RequestParam(value = "pageSize", required = false) @ApiParam(value = BrapiPagedResult.PAGE_SIZE_DESCRIPTION, required = false) final Integer pageSize) {
    ...
    @RequestMapping(value = "/{crop}/brapi/v1/studies/{studyDbId}/table", method = {RequestMethod.GET, RequestMethod.POST})
    @ResponseBody
    public ResponseEntity<StudyObservations> getStudyObservationsAsTable(final HttpServletResponse response,
        ...
        return this.getStudyObservationsResponseEntity(response, studyDbId, format, crop);
    }

    private ResponseEntity<StudyObservations> getStudyObservationsResponseEntity(final HttpServletResponse response, @PathVariable final int studyDbId, @RequestParam(value = "format", required = false) @ApiParam(value = "The format parameter will cause the data to be dumped to a file in the specified format", required = false) final String format, final String cropName) throws Exception {
    ...
    @RequestMapping(value = "/brapi/v1/studies/{studyDbId}/table", method = {RequestMethod.GET, RequestMethod.POST})
    @ResponseBody
    public ResponseEntity<StudyObservations> getStudyObservationsAsTable(final HttpServletResponse response, @PathVariable final int studyDbId,
                                                                         @ApiParam(value = "The format parameter will cause the data to be dumped to a file in the specified format",
                                                                                 required = false) @RequestParam(value = "format", required = false) final String format)
            throws Exception {
        ...
        return this.getStudyObservationsResponseEntity(response, studyDbId, format, cropName);
    }
    ...
    public ResponseEntity<StudyDetails> getStudyDetails(@PathVariable final String crop, @PathVariable final Integer studyDbId) {
        ...
        return this.getStudyDetailsResponseEntity(studyDbId);

    }

    private ResponseEntity<StudyDetails> getStudyDetailsResponseEntity(@PathVariable final Integer studyDbId) {
    ...
    private StudyDetails getStudyDetailsEntity(final StudyDetailsDto mwStudyDetails) {
...
//        metadata.setStatus(Collections.singletonList(new HashMap<>()));
    ...
    @RequestMapping(value = "/brapi/v1/studies/{studyDbId}", method = RequestMethod.GET)
    @JsonView(BrapiView.BrapiV1_3.class)
    public ResponseEntity<StudyDetails> getStudyDetails(@PathVariable final Integer studyDbId) {
    ...
    public ResponseEntity<EntityListResponse<VariableDTO>> getObservationVariables(final HttpServletResponse response,
        ...
        return getEntityListResponseResponseEntity(studyDbId, currentPage, pageSize, datasetId, crop);
    }

    private ResponseEntity<EntityListResponse<VariableDTO>> getEntityListResponseResponseEntity(@PathVariable int studyDbId, @RequestParam(value = "page", required = false) @ApiParam(value = BrapiPagedResult.CURRENT_PAGE_DESCRIPTION, required = false) Integer currentPage, @RequestParam(value = "pageSize", required = false) @ApiParam(value = BrapiPagedResult.PAGE_SIZE_DESCRIPTION, required = false) Integer pageSize, Integer datasetId, String cropName) {
    ...
    @RequestMapping(value = "/brapi/v1/studies/{studyDbId}/observationvariables", method = RequestMethod.GET)
    @ResponseBody
    public ResponseEntity<EntityListResponse<VariableDTO>> getObservationVariables(final HttpServletResponse response,
        ...
        return getEntityListResponseResponseEntity(studyDbId, currentPage, pageSize, datasetId, cropName);
    }
    ...
    public ResponseEntity<EntityListResponse<PhenotypeSearchDTO>> listObservationUnitsByStudy(
            @PathVariable final String crop, @PathVariable final int studyDbId,
            @ApiParam(value = "The granularity level of observation units. see GET /observationlevels") @RequestParam(required = false) final String observationLevel,
