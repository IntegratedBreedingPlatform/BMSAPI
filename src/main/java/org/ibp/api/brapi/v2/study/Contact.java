...
@AutoProperty @JsonInclude(JsonInclude.Include.NON_NULL) @JsonPropertyOrder({"contactDbId", "name", "email", "type", "orcid", "instituteName"})
public class Contact {
	 ...
	 * @return Contact
	 */
	public Contact setInstituteName(final String instituteName) {
