...
import org.generationcp.middleware.service.impl.gobii.GOBiiServiceImpl;
...
public class MiddlewareFactory {
	...
	@Bean
	@DependsOn("WORKBENCH_SessionFactory")
	public GOBiiService getGOBiiService() {
		return new GOBiiServiceImpl(this.getWorkbenchSessionProvider());
	}
