...
import org.generationcp.middleware.api.brapi.*;
...
import org.generationcp.middleware.api.germplasm.*;
...
import org.generationcp.middleware.api.template.TemplateServiceImpl;
...
import org.generationcp.middleware.service.api.ontology.*;
...
import org.generationcp.middleware.service.impl.crossplan.CrossPlanServiceImpl;
import org.generationcp.middleware.service.impl.crossplan.CrossPlanTreeServiceImpl;
...
public class MiddlewareFactory {
	...
	public TemplateService getTemplateService() {
		return new TemplateServiceImpl(this.getCropDatabaseSessionProvider());
	}


	@Bean
	@Scope(value = "request", proxyMode = ScopedProxyMode.TARGET_CLASS)
	public CrossPlanService getCrossPlanService() {
		return new CrossPlanServiceImpl(this.getCropDatabaseSessionProvider());
	}

	@Bean
	@Scope(value = "request", proxyMode = ScopedProxyMode.TARGET_CLASS)
	public CrossPlanTreeService getCrossPlanTreeServiceService() {
		return new CrossPlanTreeServiceImpl(this.getCropDatabaseSessionProvider());
	}
