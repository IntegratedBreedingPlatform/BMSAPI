...
public interface SecurityService {
	...
	/**
	 * Determines whether the given germplasm list is accessible to curently logged in user. Germplasm list is accessible if the logged in
	 ...
	 */
	boolean isAccessible(GermplasmList germplasmList);
