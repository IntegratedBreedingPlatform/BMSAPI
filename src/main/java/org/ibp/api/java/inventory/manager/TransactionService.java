...
public interface TransactionService {
	...
	void confirmPendingTransactions(SearchCompositeDto<Integer> searchCompositeDto);
	...
	void cancelPendingTransactions(SearchCompositeDto<Integer> searchCompositeDto);
